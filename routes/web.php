...
Route::get('/auth/github', [
    'uses' => 'Auth\AuthController@redirectToGithub',
    'as'   => 'github.login'
]);
Route::get('/auth/github/callback', [
    'uses' => 'Auth\AuthController@handleGithubCallback',
    'as'   => 'github.callback'
]);
Route::get('/github/register', [
    'uses' => 'Auth\AuthController@registerFromGithub',
    'as'   => 'github.register'
]);
...
Route::get('/readNotification/{id}', [
    'uses' => 'UserController@readNotification',
    'as'   => 'user.readNotification'
]);
...
Route::patch('/user/upload/profile', [
    'uses' => 'UserController@uploadProfile',
