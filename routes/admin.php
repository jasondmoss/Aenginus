...
Route::post('/settings', [
    'uses' => 'AdminController@saveSettings',
    'as'   => 'admin.save-settings'
]);
...
Route::get('/images', [
    'uses' => 'ImageController@images',
    'as'   => 'admin.images'
]);
Route::get('/files', [
    'uses' => 'FileController@files',
    'as'   => 'admin.files'
]);
Route::get('/ips', [
    'uses' => 'AdminController@ips',
    'as'   => 'admin.ips'
]);
...
Route::post('/post/{post}/config', [
    'uses' => 'PostController@updateConfig',
    'as'   => 'post.config'
]);
 ...
 * IPs.
 */
Route::delete('/ip/{ip}/toggle', [
    'uses' => 'IpController@toggleBlock',
    'as'   => 'ip.block'
]);
Route::delete('/ip/{ip}', [
...
Route::get('/failed-jobs', [
    'uses' => 'AdminController@failedJobs',
    'as'   => 'admin.failed-jobs'
]);
Route::delete('/failed-jobs', [
    'uses' => 'AdminController@flushFailedJobs',
    'as'   => 'admin.failed-jobs.flush'
]);
